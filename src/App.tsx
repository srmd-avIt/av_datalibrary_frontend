...
const VIEW_CONFIGS: Record<string, any> = {
  events: {
    ...
    columns: [
      ...
      {key:"SubmittedDate", label:"Submitted Date", sortable:true, editable:true},
       ...
       {key:"CommonID", label:"CommonID", sortable:true, editable:true},
       {key:"IsSubEvent1", label:"Is Sub Event 1", sortable:true, editable:true},
       {key:"IsAudioRecorded", label:"Is Audio Recorded", sortable:true, editable:true},
       {key:"PravachanCount", label:"Pravachan Count", sortable:true, editable:true},
       {key:"UdhgoshCount", label:"Udhgosh Count", sortable:true, editable:true},
       {key:"PaglaCount", label:"Pagla Count", sortable:true, editable:true},
       {key:"PratisthaCount", label:"Pratistha Count", sortable:true, editable:true},
       ...
       {key:"LastModifiedBy", label:"Last Modified By", sortable:true, editable:false},
  ...
  medialog_all: {
    ...
    columns: [
      ...
      { key: "LastModifiedTimestamp", label: "LastModifiedTimestamp", sortable: true, editable: false },
      { key: "LastModifiedBy", label: "LastModifiedBy", sortable: true, editable: false },
      ...
      { key: "Masterquality", label: "DR Master Quality", sortable: true, render: categoryTagRenderer, editable: true },
       ...
       { key: "SatsangStart", label: "Satsang Start ", sortable: true, editable: true },
        ...
        {key:"SubDetail", label:"Sub Detail", sortable:true, editable:true},
  ...
  medialog_all_except_satsang: {
    ...
    columns: [
      ...
      { key: "DistributionDriveLink", label: "DistributionDriveLink", sortable: true, editable: true },
       ...
       {key:"SatsangStart", label:"Satsang Start", sortable:true, editable:true },
       {key:"SatsangEnd", label:"Satsang End", sortable:true, editable:true },
       {key:"LockedBy", label:"Locked By", sortable:true, editable:false },
       {key:"LockStatus", label:"Lock Status", sortable:true, editable:false, render: categoryTagRenderer },
    ],
  },
     ...
     {key:"MLUniqueID", label:"MLUniqueID", sortable:true, editable:true},
      ...
      {key:"CounterTo", label:"Counter To", sortable:true, editable:true},
       ...
       {key:"fkOccasion", label:"Occasion", sortable:true, editable:true, render: categoryTagRenderer},
        ...
        {key:"Topic", label:"Topic", sortable:true, editable:true, render: categoryTagRenderer},
        {key:"SpeakerSinger", label:"Speaker / Singer", sortable:true, editable:true },
          {key:"fkOrganization", label:"Organization", sortable:true, editable:true, render: categoryTagRenderer},
        {key:"Designation", label:"Designation", sortable:true, editable:true },
          {key:"fkCountry", label:"Country", sortable:true, editable:true, render: categoryTagRenderer},
        {key:"fkState", label:"State", sortable:true, editable:true, render: categoryTagRenderer},
...
{key:"Guidance", label:"Guidance", sortable:true, editable:true},
      ...
      { key: "EventRefMLID", label: "EventRefMLID", sortable: true, editable: true },
      {key:"EventRefMLID2", label:"EventRefMLID2", sortable:true, editable:true},
        { key: "DubbedLanguage", label: "DubbedLanguage", sortable: true, editable: true, render: categoryTagRenderer },
      { key: "DubbingArtist", label: "DubbingArtist", sortable: true, editable: true },
      { key: "HasSubtitle", label: "HasSubtitle", sortable: true, editable: true },
      { key: "SubTitlesLanguage", label: "SubTitlesLanguage", sortable: true, render: categoryTagRenderer, editable: true },
      { key: "EditingDeptRemarks", label: "EditingDeptRemarks", sortable: true, editable: true },
    ...
    columns: [
      ...
      {key:"EventRefMLID", label:"EventRefMLID", sortable:true, editable:true },
       ...
       {key:"DubbedLanguage", label:"DubbedLanguage", sortable:true, editable:true, render: categoryTagRenderer },
        {key:"DubbingArtist", label:"DubbingArtist", sortable:true, editable:true },
        {key:"HasSubtitle", label:"HasSubtitle", sortable:true, editable:true },
        {key:"SubTitlesLanguage", label:"SubTitlesLanguage", sortable:true, editable:true, render: categoryTagRenderer },
        {key:"EditingDeptRemarks", label:"EditingDeptRemarks", sortable:true, editable:true },
        {key:"EditingType", label:"EditingType", sortable:true, editable:true, render: categoryTagRenderer },
        {key:"BhajanType", label:"BhajanType", sortable:true, editable:true, render: categoryTagRenderer },
          {key:"IsDubbed", label:"IsDubbed", sortable:true, editable:true },
        {key:"NumberSource", label:"NumberSource", sortable:true, editable:true, render: categoryTagRenderer },
        {key:"TopicSource", label:"TopicSource", sortable:true, editable:true, render: categoryTagRenderer },
        {key:"LastModifiedTimestamp", label:"LastModifiedTimestamp", sortable:true, editable:false },
        {key:"LastModifiedBy", label:"LastModifiedBy", sortable:true, editable:false },
        {key:"LocationWithinAshram", label:"LocationWithinAshram", sortable:true, editable:true },
        {key:"Grading", label:"Grading", sortable:true, editable:true },
...
digitalrecordings_gsheet: {
  ...
  non_event_production: {
    ...
    columns: [
      ...
      { key: "CreatedTimestamp", label: "Created Timestamp", sortable: true, editable: false },
